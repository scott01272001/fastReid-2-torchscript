...
from fastreid.evaluation import (ReidEvaluator, print_csv_format)

from custom_evaluator import inference_on_dataset
...
class DefaultPredictor:
    ...
    def __init__(self, cfg):
        ...
        self.model = torch.jit.load(cfg.MODEL.WEIGHTS, map_location=torch.device(cfg.MODEL.DEVICE))
        self.model.eval()
    ...
    def __call__(self, image):
        ...
        """
        inputs = {"images": image.to("cuda")}
        with torch.no_grad():  # https://github.com/sphinx-doc/sphinx/issues/4258
            predictions = self.model(inputs['images'])
